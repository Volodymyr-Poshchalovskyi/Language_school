export const singleFormData = {
  ...
  whatIsItText:
    'Це формат, де весь час та увага викладача присвячені <strong>лише вам</strong>. Програма навчання на 100% адаптується під ваші цілі, темп та сильні й слабкі сторони.',
