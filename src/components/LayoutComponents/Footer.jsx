    ...
    <footer className="bg-[#FFFFFF] dark:bg-gray-900 px-6 pt-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] avoid-emoji transition-colors duration-300 border-t border-[#69140E]/10 dark:border-[#FFFFFF]/10">
      <div className="w-full max-w-screen-xl mx-auto md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <ul className="flex flex-wrap items-center justify-center sm:justify-start gap-x-4 gap-y-2 mb-6 text-sm font-medium text-[#69140E]/70 dark:text-[#FFFFFF]/70 sm:mb-0">
            <li>
              <Link to="/" className="hover:text-[#E85F5C] hover:underline transition-colors">
                Головна
              </Link>
            </li>
            <li>
              <Link to="/single-form" className="hover:text-[#E85F5C] hover:underline transition-colors">
                Персональні заняття
              </Link>
            </li>
            <li>
              <Link to="/dual-form" className="hover:text-[#E85F5C] hover:underline transition-colors">
                Групові заняття
              </Link>
            </li>
            <li>
              <Link to="/about" className="hover:text-[#E85F5C] hover:underline transition-colors">
                Про нас
              </Link>
            </li>
            
            <li>
              <Link to="/privacy-policy" className="hover:text-[#E85F5C] hover:underline transition-colors">
